if getgenv().hub then warn("Realidade hub : Already executed!") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Realidade hub - Premium",
